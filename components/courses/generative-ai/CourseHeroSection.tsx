...
export default function CourseHeroSection() {
  ...
  return (
    ...
    lineHeight: "38px",
            ...
            Fellowship in Generative AI for Professionals
          </h1>

          <p style={{lineHeight: "1.75rem !important",
    fontWeight: "400",
    fontSize: "17px",}} className="mt-6 text-lg leading-relaxed text-gray-500">
            Master prompt engineering and applied GenAI tools to upskill in
            your current tech career. Progress seamlessly from{" "}
            <span className="font-semibold text-emerald-600">
              Prompt Engineering to Applied Generative AI,
            </span>{" "}
