...
export default function CourseHeroSection() {
  ...
  return (
    ...
    lineHeight: "38px",
            ...
            Fellowship Program in Cloud Engineering &amp; DevOps
          </h1>

          <p style={{lineHeight: "1.75rem !important",
    fontWeight: "400",
    fontSize: "17px",}} className="mt-6 text-lg leading-relaxed text-gray-500">
            Get hands-on with cloud infrastructure, CI/CD and automation used
            by modern engineering teams. Progress seamlessly from{" "}
            <span className="font-semibold text-emerald-600">
              Cloud Engineering to DevOps Automation,
            </span>{" "}
            with expert career guidance to land cloud and DevOps roles.
          </p>
