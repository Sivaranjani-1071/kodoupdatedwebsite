...
export default function CourseHeroSection() {
  ...
  return (
    ...
    fontSize: "17px",}} className="mt-6 text-lg leading-relaxed text-gray-500">
            Build AI-powered full-stack products end-to-end across the
            frontend and backend. Progress seamlessly from{" "}
            <span className="font-semibold text-emerald-600">
              Full-Stack Fundamentals to AI-Powered Product Development,
            </span>{" "}
            with expert career guidance to land top full-stack developer
            roles.
          </p>
