...
export default function CourseHeroSection() {
  ...
  return (
    ...
    lineHeight: "38px",
            ...
            Fellowship Program in Cybersecurity &amp; Ethical Hacking
          </h1>

          <p style={{lineHeight: "1.75rem !important",
    fontWeight: "400",
    fontSize: "17px",}} className="mt-6 text-lg leading-relaxed text-gray-500">
            Learn offensive security, ethical hacking and threat defense used
            to protect real-world systems. Progress seamlessly from{" "}
            <span className="font-semibold text-emerald-600">
              Security Fundamentals to Ethical Hacking &amp; Threat Defense,
            </span>{" "}
            with expert career guidance to land top cybersecurity roles.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {[
              ...
              "Ethical Hacking & Threat Defense",
