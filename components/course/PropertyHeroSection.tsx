...
export default function PropertyHeroSection() {
  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-12 md:grid-cols-2 md:gap-8 md:px-12 lg:px-20">
        {/* Left column */}
    ...
    lineHeight: "38px",
            ...
            Fellowship Program in NextGen Data Analytics &amp; Data Science
            with AI
          </h1>
    ...
    fontSize: "17px",}} className="mt-6 text-lg leading-relaxed text-gray-500">
            With businesses increasingly relying on data-driven
            decision-making, professionals who can analyze data and build
            intelligent models are in high demand. Progress seamlessly from{" "}
            <span className="font-semibold text-emerald-600">
              Data Analytics to Data Science with AI,
            </span>{" "}
            with expert career guidance to build a successful career in the
            Data Science Field.
          </p>

          {/* Info card */}
          <div className="mt-8 rounded-2xl bg-emerald-50 p-6 sm:p-8">
            ...
            <hr style={{borderColor: "rgb(110 110 110)",}} className="my-5 border-emerald-100" />
            ...
            <div className="flex items-center gap-10 sm:gap-16">
              ...
              <div class="h-full min-h-[40px] border-r-2 border-v5-neutral-300"></div>
              <div>
                <p className="text-xs font-semibold tracking-wide text-emerald-700">
                  LEARNING MODE
                </p>
