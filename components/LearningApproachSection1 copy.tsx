            ...
            {projects.map((project, i) => (
              <div
                ...
                className="
                  ...
                  sm:w-[300px]
                  lg:w-[330px]
                  bg-[#EFF8F4] rounded-2xl p-4 sm:p-6
                  flex flex-col items-center text-center
                  mx-auto
                "
              >
                {/* Badge */}
                <span className="bg-[#0B3B36] text-white text-[10px] sm:text-xs font-semibold px-3 sm:px-4 py-1 rounded-full mb-4 sm:mb-6">
                  {project.badge}
                </span>
                ...
                {/* Title */}
                <h3 className="font-bold text-[#1A1A1A] text-sm sm:text-lg leading-snug mb-2">
                  {project.title}
                </h3>

                {/* Description */}
                <p className="text-[#666666] text-xs sm:text-sm leading-relaxed mb-5 sm:mb-6">
                  {project.description}
                </p>
